...
type [<AllowNullLiteral>] NativeMethodsMixinStatic =
    ...
    abstract refs: {| Item: React.Component<obj option, obj option> |} with get, set
...
type [<AllowNullLiteral>] LayoutAnimationStatic =
    ...
    abstract configChecker: ({| Item: obj option |} -> obj option) with get, set
...
type [<AllowNullLiteral>] ImageURISource =
    ...
    /// </summary>
    abstract headers: {| Item: string |} option with get, set
    /// <summary>
...
type [<AllowNullLiteral>] FlatList<'ItemT> =
    ...
    abstract scrollToEnd: ({| animated: bool option |} -> unit) with get, set
...
type [<AllowNullLiteral>] ListViewProps =
    ...
    /// </summary>
    abstract onChangeVisibleRows: (Array<{| Item: {| Item: bool |} |}> -> Array<{| Item: {| Item: bool |} |}> -> unit) option with get, set
...
type [<AllowNullLiteral>] ListView =
    ...
    /// </summary>
    abstract scrollTo: (U2<float, {| x: float option; y: float option; animated: bool option |}> -> float -> bool -> unit) with get, set
...
type [<AllowNullLiteral>] ListViewDataSource =
    ...
    /// </summary>
    abstract cloneWithRows: dataBlob: U2<Array<obj option>, {| Item: obj option |}> * ?rowIdentities: Array<U2<string, float>> -> ListViewDataSource
    /// <summary>
    ...
    /// </summary>
    abstract cloneWithRowsAndSections: dataBlob: U2<Array<obj option>, {| Item: obj option |}> * ?sectionIdentities: Array<U2<string, float>> * ?rowIdentities: Array<Array<U2<string, float>>> -> ListViewDataSource
...
type [<AllowNullLiteral>] Dimensions =
    ...
    abstract set: dims: {| Item: obj option |} -> unit
...
type [<AllowNullLiteral>] InteractionManagerStatic =
    ...
    abstract runAfterInteractions: ?task: U3<(unit -> obj option), SimpleTask, PromiseTask> -> {| ``then``: ((unit -> obj option) -> (unit -> obj option) -> Promise<obj option>); ``done``: (ResizeArray<obj option> -> obj option); cancel: (unit -> unit) |}
...
type [<AllowNullLiteral>] PermissionsAndroidStatic =
    ...
    abstract RESULTS: {| Item: PermissionStatus |} with get, set
    /// A list of specified "dangerous" permissions that require prompting the user
    abstract PERMISSIONS: {| Item: Permission |} with get, set
    /// Deprecated
    ...
    abstract requestMultiple: permissions: Array<string> -> Promise<{| Item: PermissionStatus |}>
...
type [<AllowNullLiteral>] UIManagerStatic =
    ...
    /// </summary>
    abstract takeSnapshot: (U3<React.ReactElement<obj option>, float, string> -> {| width: float option; height: float option; format: UIManagerStaticTakeSnapshotFormat option; quality: float option |} -> Promise<string>) with get, set
    /// <summary>
    /// Determines the location on screen, width, and height of the given view and
    /// returns the values via an async callback. If successful, the callback will
    /// be called with the following arguments:
...
module Animated =
    ...
    type [<AllowNullLiteral>] ValueXY =
        ...
        /// </code>
        /// </summary>
        abstract getLayout: unit -> {| Item: AnimatedValue |}
        /// <summary>
        ...
        /// </code>
        /// </summary>
        abstract getTranslateTransform: unit -> ResizeArray<{| Item: AnimatedValue |}>
