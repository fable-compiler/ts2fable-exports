...
let [<Import("IsFocusVisibleClassName","@uifabric/utilities/lib/initializeFocusRects")>] IsFocusVisibleClassName: obj = jsNative
...
let [<Import("baseElementEvents","@uifabric/utilities/lib/properties")>] baseElementEvents: ResizeArray<string> = jsNative
let [<Import("baseElementProperties","@uifabric/utilities/lib/properties")>] baseElementProperties: ResizeArray<string> = jsNative
let [<Import("htmlElementProperties","@uifabric/utilities/lib/properties")>] htmlElementProperties: ResizeArray<string> = jsNative
let [<Import("anchorProperties","@uifabric/utilities/lib/properties")>] anchorProperties: ResizeArray<string> = jsNative
let [<Import("buttonProperties","@uifabric/utilities/lib/properties")>] buttonProperties: ResizeArray<string> = jsNative
let [<Import("divProperties","@uifabric/utilities/lib/properties")>] divProperties: ResizeArray<string> = jsNative
let [<Import("inputProperties","@uifabric/utilities/lib/properties")>] inputProperties: ResizeArray<string> = jsNative
let [<Import("textAreaProperties","@uifabric/utilities/lib/properties")>] textAreaProperties: ResizeArray<string> = jsNative
let [<Import("imageProperties","@uifabric/utilities/lib/properties")>] imageProperties: ResizeArray<string> = jsNative
...
let [<Import("DATA_IS_SCROLLABLE_ATTRIBUTE","@uifabric/utilities/lib/scroll")>] DATA_IS_SCROLLABLE_ATTRIBUTE: obj = jsNative
...
let [<Import("ColorClassNames","@uifabric/styling/lib/classNames/ColorClassNames")>] ColorClassNames: IColorClassNames = jsNative
...
let [<Import("AnimationVariables","@uifabric/styling/lib/styles/AnimationStyles")>] AnimationVariables: IAnimationVariables = jsNative
let [<Import("AnimationStyles","@uifabric/styling/lib/styles/AnimationStyles")>] AnimationStyles: IAnimationStyles = jsNative
type IFontStyles = ___interfaces_index.IFontStyles
let [<Import("DefaultFontStyles","@uifabric/styling/lib/styles/DefaultFontStyles")>] DefaultFontStyles: IFontStyles = jsNative
...
let [<Import("ThemeSettingName","@uifabric/styling/lib/styles/theme")>] ThemeSettingName: obj = jsNative
...
let [<Import("HighContrastSelector","@uifabric/styling/lib/styles/CommonStyles")>] HighContrastSelector: obj = jsNative
let [<Import("ScreenWidthMinSmall","@uifabric/styling/lib/styles/CommonStyles")>] ScreenWidthMinSmall: obj = jsNative
let [<Import("ScreenWidthMinMedium","@uifabric/styling/lib/styles/CommonStyles")>] ScreenWidthMinMedium: obj = jsNative
let [<Import("ScreenWidthMinLarge","@uifabric/styling/lib/styles/CommonStyles")>] ScreenWidthMinLarge: obj = jsNative
let [<Import("ScreenWidthMinXLarge","@uifabric/styling/lib/styles/CommonStyles")>] ScreenWidthMinXLarge: obj = jsNative
let [<Import("ScreenWidthMinXXLarge","@uifabric/styling/lib/styles/CommonStyles")>] ScreenWidthMinXXLarge: obj = jsNative
let [<Import("ScreenWidthMinXXXLarge","@uifabric/styling/lib/styles/CommonStyles")>] ScreenWidthMinXXXLarge: obj = jsNative
let [<Import("ScreenWidthMaxSmall","@uifabric/styling/lib/styles/CommonStyles")>] ScreenWidthMaxSmall: float = jsNative
let [<Import("ScreenWidthMaxMedium","@uifabric/styling/lib/styles/CommonStyles")>] ScreenWidthMaxMedium: float = jsNative
let [<Import("ScreenWidthMaxLarge","@uifabric/styling/lib/styles/CommonStyles")>] ScreenWidthMaxLarge: float = jsNative
let [<Import("ScreenWidthMaxXLarge","@uifabric/styling/lib/styles/CommonStyles")>] ScreenWidthMaxXLarge: float = jsNative
let [<Import("ScreenWidthMaxXXLarge","@uifabric/styling/lib/styles/CommonStyles")>] ScreenWidthMaxXXLarge: float = jsNative

type [<AllowNullLiteral>] IExports =
    abstract getScreenSelector: min: float * max: float -> string
type IRawStyle = @uifabric_merge_styles_lib_index.IRawStyle
let [<Import("normalize","@uifabric/styling/lib/styles/GeneralStyles")>] normalize: IRawStyle = jsNative
let [<Import("noWrap","@uifabric/styling/lib/styles/GeneralStyles")>] noWrap: IRawStyle = jsNative
...
type [<AllowNullLiteral>] IPartialTheme =
    ...
    abstract isInverted: bool option with get, set
    abstract disableGlobalClassNames: bool option with get, set
let [<Import("ColorClassNames","@uifabric/styling/lib-es2015/classNames/ColorClassNames")>] ColorClassNames: IColorClassNames = jsNative
...
type IAnimationStyles = ___interfaces_index.IAnimationStyles
type IAnimationVariables = ___interfaces_index.IAnimationVariables
let [<Import("AnimationVariables","@uifabric/styling/lib-es2015/styles/AnimationStyles")>] AnimationVariables: IAnimationVariables = jsNative
let [<Import("AnimationStyles","@uifabric/styling/lib-es2015/styles/AnimationStyles")>] AnimationStyles: IAnimationStyles = jsNative
type IFontStyles = ___interfaces_index.IFontStyles
let [<Import("DefaultFontStyles","@uifabric/styling/lib-es2015/styles/DefaultFontStyles")>] DefaultFontStyles: IFontStyles = jsNative
...
type ITheme = ___interfaces_index.ITheme
type IPartialTheme = ___interfaces_index.IPartialTheme
let [<Import("ThemeSettingName","@uifabric/styling/lib-es2015/styles/theme")>] ThemeSettingName: obj = jsNative
...
type [<AllowNullLiteral>] IExports =
    ...
    /// <param name="depComments">- Whether to include deprecated tags as comments for deprecated slots.</param>
    abstract createTheme: theme: IPartialTheme * ?depComments: bool -> ITheme
let [<Import("HighContrastSelector","@uifabric/styling/lib-es2015/styles/CommonStyles")>] HighContrastSelector: obj = jsNative
let [<Import("ScreenWidthMinSmall","@uifabric/styling/lib-es2015/styles/CommonStyles")>] ScreenWidthMinSmall: obj = jsNative
let [<Import("ScreenWidthMinMedium","@uifabric/styling/lib-es2015/styles/CommonStyles")>] ScreenWidthMinMedium: obj = jsNative
let [<Import("ScreenWidthMinLarge","@uifabric/styling/lib-es2015/styles/CommonStyles")>] ScreenWidthMinLarge: obj = jsNative
let [<Import("ScreenWidthMinXLarge","@uifabric/styling/lib-es2015/styles/CommonStyles")>] ScreenWidthMinXLarge: obj = jsNative
let [<Import("ScreenWidthMinXXLarge","@uifabric/styling/lib-es2015/styles/CommonStyles")>] ScreenWidthMinXXLarge: obj = jsNative
let [<Import("ScreenWidthMinXXXLarge","@uifabric/styling/lib-es2015/styles/CommonStyles")>] ScreenWidthMinXXXLarge: obj = jsNative
let [<Import("ScreenWidthMaxSmall","@uifabric/styling/lib-es2015/styles/CommonStyles")>] ScreenWidthMaxSmall: float = jsNative
let [<Import("ScreenWidthMaxMedium","@uifabric/styling/lib-es2015/styles/CommonStyles")>] ScreenWidthMaxMedium: float = jsNative
let [<Import("ScreenWidthMaxLarge","@uifabric/styling/lib-es2015/styles/CommonStyles")>] ScreenWidthMaxLarge: float = jsNative
let [<Import("ScreenWidthMaxXLarge","@uifabric/styling/lib-es2015/styles/CommonStyles")>] ScreenWidthMaxXLarge: float = jsNative
let [<Import("ScreenWidthMaxXXLarge","@uifabric/styling/lib-es2015/styles/CommonStyles")>] ScreenWidthMaxXXLarge: float = jsNative

type [<AllowNullLiteral>] IExports =
    abstract getScreenSelector: min: float * max: float -> string
type IRawStyle = @uifabric_merge_styles_lib_index.IRawStyle
let [<Import("normalize","@uifabric/styling/lib-es2015/styles/GeneralStyles")>] normalize: IRawStyle = jsNative
let [<Import("noWrap","@uifabric/styling/lib-es2015/styles/GeneralStyles")>] noWrap: IRawStyle = jsNative
...
type [<AllowNullLiteral>] IExports =
    ...
    /// <param name="dest">- The object to hoist the methods onto.</param>
    abstract hoistStatics: source: 'TSource * dest: 'TDest -> 'TDest
let [<Import("IsFocusVisibleClassName","@uifabric/utilities/lib-es2015/initializeFocusRects")>] IsFocusVisibleClassName: obj = jsNative
...
type [<AllowNullLiteral>] IExports =
    ...
    /// <param name="element">- Element to check for overflow</param>
    abstract hasOverflow: element: HTMLElement -> bool
let [<Import("baseElementEvents","@uifabric/utilities/lib-es2015/properties")>] baseElementEvents: ResizeArray<string> = jsNative
let [<Import("baseElementProperties","@uifabric/utilities/lib-es2015/properties")>] baseElementProperties: ResizeArray<string> = jsNative
let [<Import("htmlElementProperties","@uifabric/utilities/lib-es2015/properties")>] htmlElementProperties: ResizeArray<string> = jsNative
let [<Import("anchorProperties","@uifabric/utilities/lib-es2015/properties")>] anchorProperties: ResizeArray<string> = jsNative
let [<Import("buttonProperties","@uifabric/utilities/lib-es2015/properties")>] buttonProperties: ResizeArray<string> = jsNative
let [<Import("divProperties","@uifabric/utilities/lib-es2015/properties")>] divProperties: ResizeArray<string> = jsNative
let [<Import("inputProperties","@uifabric/utilities/lib-es2015/properties")>] inputProperties: ResizeArray<string> = jsNative
let [<Import("textAreaProperties","@uifabric/utilities/lib-es2015/properties")>] textAreaProperties: ResizeArray<string> = jsNative
let [<Import("imageProperties","@uifabric/utilities/lib-es2015/properties")>] imageProperties: ResizeArray<string> = jsNative
...
type [<AllowNullLiteral>] IExports =
    ...
    /// Returns the given key, but flips right/left arrows if necessary.
    abstract getRTLSafeKeyCode: key: float -> float
let [<Import("DATA_IS_SCROLLABLE_ATTRIBUTE","@uifabric/utilities/lib-es2015/scroll")>] DATA_IS_SCROLLABLE_ATTRIBUTE: obj = jsNative
