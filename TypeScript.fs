...
module Ts =
    ...
    type [<AllowNullLiteral>] IExports =
        ...
        /// <param name="location">The location for the expression. Defaults to the positions from "original" if provided.</param>
    ...
    type [<AllowNullLiteral>] Iterator<'T> =
        abstract next: unit -> U2<{| value: 'T; ``done``: bool option |}, {| value: obj; ``done``: bool |}>
